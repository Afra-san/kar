  ...
  return (
    <div className="w-full h-screen bg-[#F5F5F4] flex items-start justify-center">
        ...
        <motion.h1 initial={{ opacity: 0}}
                   ...
                   className='text-4xl font-light absolute transform-1 md:text-6xl'>محمد افرا</motion.h1>
        ...
        <motion.p  initial={{ opacity: 0}}
                   ...
                   className=" font-light text-sm absolute transform-3 text-end md:text-lg">
